...
# Load the data
train_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test/TY/train', transform=transform)
val_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test/TY/val', transform=transform)
#test_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test/TY/test', transform=transform)
...
output_dir = f'/data/wesley/3_data_7_31_23/model_outputs/TY/{optimizer_name}_{weights_str}_{timestamp}'

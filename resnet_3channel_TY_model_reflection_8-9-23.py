...
# Load the data
train_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test_reflection/TY/train', transform=transform)
val_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test_reflection/TY/val', transform=transform)
#test_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test_reflection/TY/test', transform=transform)
...
weights = [0.74, 0.26]  # class 0 is "Passes" and class 1 is "Fails"

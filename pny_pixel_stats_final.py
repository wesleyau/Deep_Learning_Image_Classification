...
def save_statistics_to_file(folder_path, folder_stats, output_folder):
...
for root, dirs, files in os.walk(tx_directory):
    ...
    if folder_stats:
        ...
        save_statistics_to_file(root, folder_stats, tx_output_folder)
...
for root, dirs, files in os.walk(ty_directory):
    ...
    if folder_stats:
        ...
        save_statistics_to_file(root, folder_stats, ty_output_folder)

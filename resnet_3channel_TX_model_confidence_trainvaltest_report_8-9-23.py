...
# Load the data
train_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test/TX/train', transform=transform)
val_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test/TX/val', transform=transform)
#test_data = CustomImageFolder('/data/wesley/3_data_7_31_23/train_test/TX/test', transform=transform)
...
output_dir = f'/data/wesley/3_data_7_31_23/model_outputs/TX/{optimizer_name}_{weights_str}_{timestamp}'
...
# Training loop
for epoch in range(16):  # 10 epochs, adjust as needed
    model.train()  
    train_loss = 0.0
    train_corrects = 0

    ...
    for file_name in filenames:
        ...
        if file_name.endswith('.npy'):
            ...
            if len(non_zero_indices) > 0 and all(len(indices) > 0 for indices in non_zero_indices):
                ...
                vmin, vmax = None, None
                if 'Co_image' in file_name:
                    vmin, vmax = 117.58638676708651, 123.66742278972193 #upping bottom makes more purple, lowering bottom makes purples more visible
                elif 'Am_image' in file_name:
                    ...
                    vmin, vmax = 0.09101281309950424, 0.110869273830448 #lower top, makes more yellow
                elif 'TC_image' in file_name:
                    vmin, vmax = 0.9805468832682494, 1.032908229722682 #raising top, makes more yellow
                else:
